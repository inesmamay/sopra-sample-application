package com.github.sopra.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SoprarSampleApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SoprarSampleApplication");
        ...
        config.getMapConfigs().put("com.github.sopra.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
